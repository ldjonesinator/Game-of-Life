...
CODEDIRS = $(SOURCE_DIR) $(ENGINE_DIR) $(IMGUI_DIR) $(GLM_DIR) $(TEST_DIR)
INCDIRS = $(SOURCE_DIR) $(ENGINE_DIR) $(IMGUI_DIR) $(GLM_DIR) $(TEST_DIR)
...
.PHONY: clean
clean:
	$(info Attempting to remove the program file, object files, and dependency files:)
	$(NLINE)
